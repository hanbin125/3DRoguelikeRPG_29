...
public class TestPlayerUI : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        //UpdateMaxHP(_playerStat.GetStatValue(StatType.MaxHP));
        UpdateHP(_playerStat.GetStatValue(PlayerStatType.HP));
        //UpdateMaxMP(_playerStat.GetStatValue(StatType.MaxMP));
        //UpdateMP(_playerStat.GetStatValue(StatType.MP));
        UpdateSpeed(_playerStat.GetStatValue(PlayerStatType.Speed));
        //UpdateAttack(_playerStat.GetStatValue(StatType.Attack));
        //UpdateDMGReduction(_playerStat.GetStatValue(StatType.DMGReduction));
        //UpdateCriticalChance(_playerStat.GetStatValue(StatType.CriticalChance));
        //UpdateCriticalDamage(_playerStat.GetStatValue(StatType.CriticalDamage));
    }
